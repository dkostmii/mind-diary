export default {
  ...
  onboarding: {
    ...
    atomsFadeExplain: "Але атоми згасають з часом, як справжні спогади. Чим більше взаємодієш — тим швидше згасають ті, яких не чіпаєш.",
    ...
    moleculeExplain: "Молекула — це група атомів, які ти зв'язав(ла). Об'єднання зміцнює їх — вони триматимуться довше.",
    detailPrompt: "Затисни молекулу, щоб відкрити деталі.",
    detailExplain: "Тут ти можеш переглянути атоми всередині. Відкриття атома зміцнює його.",
    fadeExplain: "Молекули теж згасають. Коли молекула згасне достатньо — вона розпадається на атоми. Атоми зміцнюються, щоб ти встиг(ла) їх зібрати знову.",
    doneMessage: "Ти готовий/готова. Пиши, об'єднуй, повертайся.",
    start: "Почати",
  },
  ...
  detail: {
    ...
    tapToReveal: "Натисни, щоб прочитати",
  },
