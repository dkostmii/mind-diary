export default {
  ...
  onboarding: {
    appDescription: "Пиши думки — вони розкладаються на атоми. Атоми згасають, як справжні спогади. Об'єднуючи їх у молекули, ти створюєш зв'язки між ідеями — саме так мозок закріплює знання. Чим частіше переосмислюєш — тим міцніше пам'ятаєш.",
